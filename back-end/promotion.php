...
<table  border="1">
    ...
    <tr>
        <td  style="width: 20%"><a href="#" onclick="sortTable(this,0); return
    false;"> ID </a></td>
...
<div class="imprimer" align="center">
        ...
        <input id="impression" name="impression" class="btn btn-primary" type="submit" onclick="imprimer_page()" value="Imprimer " />
...
foreach($connection->query('SELECT idpromotion,MAX(pourcentage) FROM promotion WHERE pourcentage=(SELECT MAX(pourcentage) FROM promotion)') as $row) {


echo "<fildset>";
echo '<legend> Meilleur Promotion </legend>';
echo "</fildset>";

echo "<tr>";
echo "<td width='100'> ID Promotion </td>";

echo "<td width='100'> Pourcentage </td>";
echo "</tr>";


echo "<tr>";
echo "<td width='150'>" . $row['idpromotion'] . "</td>";
echo "<td width='100'>" . $row['MAX(pourcentage)'] . "</td>";
echo "</tr>";
