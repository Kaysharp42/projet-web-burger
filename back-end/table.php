                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">table client</h3>
                               ...
                               <button class="au-btn--submit" type="submit" name="search">
                                   <i class="zmdi zmdi-search"></i>
                                            ...
                                            <h3  style="color:black " >Trier les clients selon la date de creation de compte<button> <img src="images/d.png"></button> </h3>
                                </form>
                                    </div>
                                    <div class="table-data__tool-right">
                                      
                                       <button name="imprimer" onclick="PrintDiv();" ><img src="images/impr.png">imprimer</button>
       ...
       popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
        popupWin.document.close();
                                         ...
                                         <form action="statistiquesClient.php">
                                          <button name="Statistiques" >  <img src="images/stat.png">statistique</button>
                                ...
                                <div class="table-responsive table-responsive-data2" id="HTMLtoPDF">
