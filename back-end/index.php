...
foreach($connection->query('SELECT count(id) from user ') as $row) {



echo "<a> " . $row['count(id)'] . "</a>";
...
foreach($connection->query('SELECT sum(quantity) from commandes ') as $row) {



echo "<a> " . $row['sum(quantity)'] . "</a>";
...
foreach($connection->query('SELECT count(id) from commandes ') as $row) {
...
?>   
                                                ...
                                                <span>transaction this week</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
...
foreach($connection->query('SELECT sum(amount) from commandes ') as $row) {



echo "<a> " . $row['sum(amount)'] . "TND</a>";
