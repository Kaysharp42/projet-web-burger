...
foreach($listecategorie as $row1){
    ?>
									...
									<ul>
										<li><a href="Menu.php?cat=<?= $row1["id"]; ?>">  <?PHP echo $row1['nom']; ?>   </a></li>
						...
						<div class="w3ls_mobiles_grid_right_grid2_right">
							<label>
									...
									<select class="input-select" size="1" onChange="location = this.options[this.selectedIndex].value;">
										<option value="Menu1.php?produit1=1">Default</option>
										<option value="Menu1.php?ProduitsTries=1">Le moins cher</option>
										<option value="Menu1.php?ProduitsTriesDesc=1">Le Plus cher</option>
										<option value="Menu1.php?ProduitsTriesA=1"> A-Z</option>
										<option value="Menu1.php?ProduitsTriesZ=1">Z-A</option>
										<option value="Menu1.php?ProduitsTriesQA=1">Le plus Quant</option>
										<option value="Menu1.php?ProduitsTriesQD=1">Le moins Quant</option>
									</select>
								</label>
...
$produit1c=new produitc();
	...
	{  //$liste = $produitc->rechercherProduits($_GET['search']);
	 ...
	 {//echo ($_GET['cat']);
	 	$liste = $produit1c->rechercher_cat($_GET['cat']);
	 	//print_r($liste);
	 }
...
<script>
function myfunction() {
	 	Swal.fire('Oops...', 'You must log in to add to cart !', 'error');
  $('#myModal88').modal('show');
